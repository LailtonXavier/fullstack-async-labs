        ...
        <div className="relative grid grid-cols-1 gap-12 sm:grid-cols-1 lg:grid-cols-2">
          {data?.products && data.products.length > 0 ? (
            data?.products?.map((product: ProductProps) => (
              <div key={product.id} className="group relative overflow-hidden rounded-2xl">
                <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-gray-100">
                  ...
                  {product.photo && (
                    <Image
                      src={
                        product.photo || DefaultImage.src}
                      alt={product.name}
                      fill
                  ...
                  <div
                    className="
                      ...
                      bg-white p-6 shadow-xl opacity-0
                  ...
                  >
                    ...
                    <div className="flex w-full justify-end">
                      <button className="flex items-center gap-3 rounded-xl bg-black px-5 py-3 text-sm font-medium text-white transition hover:opacity-90 dark:bg-white dark:text-black"
                  ...
                  <div
                    className="
                      ...
                      justify-between p-4 transition-opacity
